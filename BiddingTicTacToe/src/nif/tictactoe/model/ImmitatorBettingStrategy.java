...
public class ImmitatorBettingStrategy implements Serializable, Comparable<ImmitatorBettingStrategy>, IStrategy  {
	...
	public ImmitatorBettingStrategy(int[] bides, int wins, int loses, UUID saveNumber) {
		_bides = bides;
		_itterator = 0;
		_wins = wins;
		_loses = loses;
	...
	@Override
	public int compareTo(ImmitatorBettingStrategy o) {			
